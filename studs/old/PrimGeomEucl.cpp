//Primitivas geom�tricas para retas e triângulos e circulos
#include<iostream>
#include<iomanip>
#include<cmath>
...
double AreaTrianguloNaoSinalizada(ponto p1, ponto p2,ponto p3){
...
void ExemploRotacaoHoraria(){
    ...
    cout<<"Entre com x e y de três pontos do triângulo: ";
    for(i = 0; i<3; i++) cin>>Tri1[i].x>>Tri1[i].y;
    cout<<"Quer informar o angulo em radianos? S ou N: "; cin>>resposta;
    if (resposta == 's' || resposta == 'S'){
        cout<<"Entre com o ângulo de rotacao(radianos): "; cin>>alfa;
    }
    else{
      cout<<"Entre com o ângulo de rotacao(graus): "; cin>>alfa;
      alfa = PI*alfa/180;
    }
...
void ExemploAreaTriangulo(){
    ...
    cout<<"Area do triângulo: "<<AreaTriangulo(p1,p2,p3)<<endl<<endl;
}
...
void ExemploTangentes() {
    ...
    cout<<"Entre com o centro (x e y) e o raio do c�rculo: ";
    cin>>c.pc.x>>c.pc.y>>c.raio;
    cout<<"Entre com o ponto de teste(x e y): ";
    cin>>p1.x>>p1.y;
    if (PontoInteriorCirculo(p1,c)) cout<<"Ponto interior ao circulo"<<endl;
...
int main(){
    cout.setf(ios_base::fixed); //a parte fracionária do número em ponto flutuante será impressa com exatamente a quantidade de digitos
    cout.precision(2);		//especificados pela precisão, nesse caso com 2 casas decimas.
